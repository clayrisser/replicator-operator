...
import (
	...
	"github.com/silicon-hills/replicator-operator/controllers"
...
func init() {
	...
	utilruntime.Must(replicatorv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "85a8f59d.siliconhills.dev",
	})
	if err != nil {
	...
	if err = (&controllers.ReplicatorReconciler{
		...
		Log:    ctrl.Log.WithName("controllers").WithName("Replicator"),
